...
- Wails v2/v3 official docs — verified constraints, see `references/wails-constraints.md`
  (static build, HashRouter, `base: "./"`, `@wailsio/runtime`, bindings, dev port).
- Wails v2/v3 backend conventions (Go app menu, window config) — see Théo's go-dev-kit.
