...
function SectionHeadingTitle<T extends HeadingTypes = "h2">({
  ...
  return (
    <Comp
      ...
      className={cn(
        "font-heading scroll-m-20 text-4xl font-medium tracking-tight text-balance group-data-[size=sm]/section-heading:text-3xl lg:text-5xl lg:group-data-[size=sm]/section-heading:text-4xl",
        className
      )}
      {...props}
    />
