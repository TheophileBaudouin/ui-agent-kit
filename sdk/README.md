...
| Folder | Role |
| --- | --- |
| `ui-sdk/` | 62 license-verified components & blocks: charts, settings, upload, page blocks + **agent chat kit** (assistant-ui base + AgentChat, ToolCallCard, ApprovalCard…) + index + consumption guide |
